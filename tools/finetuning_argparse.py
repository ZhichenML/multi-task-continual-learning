...
def get_argparse():
    ...
    parser.add_argument("--per_gpu_train_batch_size", default=15, type=int,
    ...
    parser.add_argument("--adapter_layers", default=3, type=int,
                        help="The number of layers for adapter", )
