...
def collate_fn(batch):
    ...
    """
    all_input_ids, all_input_mask, all_segment_ids, all_start_ids,all_end_ids,all_lens, cates_ids, acts_ids = map(torch.stack, zip(*batch))
    ...
    return all_input_ids, all_input_mask, all_segment_ids, all_start_ids,all_end_ids,all_lens, cates_ids, acts_ids
...
def convert_examples_to_features(examples,label_list,max_seq_length,tokenizer,
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        # print("subjects_ids: ", subjects_id)
        # input("pause")
