...
def collate_fn(batch):
    ...
    """
    all_input_ids, all_attention_mask, all_token_type_ids, all_lens, all_labels, cates_ids, acts_ids = map(torch.stack, zip(*batch))
    ...
    return all_input_ids, all_attention_mask, all_token_type_ids, all_labels, all_lens, cates_ids, acts_ids
